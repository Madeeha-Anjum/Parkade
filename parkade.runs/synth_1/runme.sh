...
HD_PWD='C:/Users/gaiya/Desktop/lab2-sd/lab2-parkade-eclass/parkade/parkade.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parkade.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parkade.tcl
