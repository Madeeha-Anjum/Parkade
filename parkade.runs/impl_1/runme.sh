...
HD_PWD='C:/Users/gaiya/Desktop/lab2-sd/lab2-parkade-eclass/parkade/parkade.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parkade.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parkade.tcl -notrace
